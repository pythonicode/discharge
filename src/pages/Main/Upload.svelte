...
<div
  class={`flex flex-col items-center justify-center gap-2 w-full h-4/5 border-4 border-dashed border-gray-700 m-10 hover:bg-gray-800 cursor-pointer hover:border-light transition-colors duration-300 ${
...
>
  ...
  <div class="text-sm text-gray-500">Cannot Exceed 30 GB</div>
</div>
